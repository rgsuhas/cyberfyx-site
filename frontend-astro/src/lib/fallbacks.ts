...
export const CYBERSECURITY_FALLBACK: SolutionTrackDetail = {
  ...
  hero_body:
    "Risk reduction, testing, privacy, and strategic leadership for teams that need practical security programs, assurance, and decision support.",
  cta_label: "Get in touch",
  cta_target: "/contact",
  display_order: 1,
  meta_title: "Cybersecurity | Cyberfyx",
  meta_description:
    "Risk reduction, testing, privacy, and strategic leadership.",
  offerings: [
    {
      ...
      description:
        "Comprehensive testing across web, mobile, network, and cloud infrastructure.",
      display_order: 1,
      taxonomy_terms: [],
    },
    {
      ...
      description:
        "Strategic leadership, roadmap planning, and board-level reporting.",
      display_order: 2,
      taxonomy_terms: [],
    },
  ],
...
export const IT_SECURITY_FALLBACK: SolutionTrackDetail = {
  ...
  title: "IT Security",
  short_summary:
    "Framework implementation, internal audits, continuity, and cloud governance.",
  hero_title: "IT Security",
  hero_body:
    "Framework implementation, internal audits, continuity, and cloud governance for organizations that need standards translated into working controls.",
  cta_label: "Get in touch",
  cta_target: "/contact",
  display_order: 2,
  ...
  offerings: [
    {
      ...
      description:
        "Get audit-ready and build robust ISMS tailored to your business needs.",
      display_order: 1,
      taxonomy_terms: [],
    },
    {
      ...
      description:
        "Build resilience and disaster recovery strategies mapping to ISO 22301.",
      display_order: 2,
      taxonomy_terms: [],
    },
  ],
...
export const ENDPOINT_FALLBACK: SolutionTrackDetail = {
  ...
  hero_body:
    "Visibility, automation, monitoring, and lifecycle control for IT teams balancing device growth, compliance, and resilience.",
  cta_label: "Get in touch",
  cta_target: "/contact",
  display_order: 3,
  meta_title: "Endpoint Operations | Cyberfyx",
  meta_description:
    "Visibility, automation, monitoring, and lifecycle control.",
  offerings: [
    {
      slug: "uem-deployment",
      ...
      description:
        "Implement comprehensive control, tracking, and management for vast device fleets.",
      display_order: 1,
      taxonomy_terms: [],
    },
    {
      ...
      description:
        "Continuous monitoring to detect non-compliance and secure the expanded attack surface.",
      display_order: 2,
      taxonomy_terms: [],
    },
  ],
...
export const CORE_INDUSTRY_FALLBACK: SolutionTrackDetail = {
  ...
  hero_body:
    "Management systems, sector audits, and industrial assurance for operations and supplier teams.",
  cta_label: "Get in touch",
  cta_target: "/contact",
  display_order: 4,
  meta_title: "Core Industry Services | Cyberfyx",
  meta_description:
    "Management systems, sector audits, and industrial assurance.",
  offerings: [
    {
      ...
      description:
        "Prepare for external audits with robust internal documentation and mock inspections.",
      display_order: 1,
      taxonomy_terms: [],
    },
    {
      ...
      description:
        "Deploy industrial standards and integrate QMS for superior supply chain confidence.",
      display_order: 2,
      taxonomy_terms: [],
    },
  ],
...
export const TRAINING_FALLBACK: SolutionTrackDetail = {
  ...
  title: "Training",
  short_summary:
    "Capability building for security, privacy, governance, and recovery teams.",
  hero_title: "Training",
  hero_body:
    "Capability building for organizations that need internal awareness and audit readiness to sustain change.",
  cta_label: "Get in touch",
  cta_target: "/contact",
  display_order: 5,
  ...
  offerings: [
    {
      ...
      description:
        "Strategic cyber awareness programs targeted to board members and executives.",
      display_order: 1,
      taxonomy_terms: [],
    },
    {
      ...
      description:
        "Hands-on skill building for SOC analysts, network engineers, and IT administrators.",
      display_order: 2,
      taxonomy_terms: [],
    },
  ],
...
export const CONTACT_PROFILE_FALLBACK: ContactProfile = {
  ...
  map_url:
    "https://www.google.com/maps/search/?api=1&query=Janardhana%20Towers%2C%20Ashok%20Nagar%2C%20Bengaluru%20560025",
  office_regions: [{ slug: "bangalore", label: "Bangalore", display_order: 1 }],
  interest_options: [
    {
